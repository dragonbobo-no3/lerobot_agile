...
def main():
    ...
    video_root = "/home/agx/jedata/test_0807a_modified"
    image_repo_id = "lerobot/test"
    image_root = "/home/agx/jedata/lerobot_test_image_out/"
    # 构造 features 字典
    features = {
    ...
    for eid in unique_episode_ids:
        ...
        for t, idx in enumerate(episode):
            ...
            for cam_key in [
                ...
                frame[cam_key] = img
            dataset.add_frame(frame, task=step.get("task", default_prompt), timestamp=step.get("timestamp", t / 30.0))
